    ...
    <v-layout class="actions-wrapper">
      ...
      <v-flex xs6>
        ...
        >
          ...
          <v-btn @click="navigateTo(`author-quotes/${currentUserId}`)" round small color="white">
...
export default {
  ...
  computed: {
    currentUserId() {return this.$store.getters.loggedInUser.uid}
  }
};
</script>
...
.shady {
  ...
  height: 100vh;
  width: 100vw;
  background-color: rgba(4, 0, 66, 0.568);
}
.speed-dial-custom {
  margin-right: 10px;
}
